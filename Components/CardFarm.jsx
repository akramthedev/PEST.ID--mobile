      ...
      <TouchableOpacity key={item.id} style={styles.card} onPress={ 
        ...
        <View style={styles.row}>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.details}>Superficie : {item.size !== null && item.size !== "" ? <>{item.size}&nbsp;hectare</>  : "---"}</Text>
            <Text style={styles.details}>Localisation : {item.location ===  null || item.location === "" ? "---" : item.location}</Text>
