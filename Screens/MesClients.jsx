...
import { ScrollView,Image, StyleSheet, TouchableOpacity,RefreshControl, Text, View, PanResponder, Animated, Dimensions, Alert } from 'react-native';
            ...
            if (response.status === 200) {
              ...
              if (response.data) {
                ...
                response.data.users.forEach(user => {
                  if (user.id !== userIdNum && user.isEmailVerified === 1) {
                    demandCount++;
                  }
                });
                setNumberOfClients(demandCount);
              }
            } else {
