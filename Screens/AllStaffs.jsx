...
import { Image, ScrollView, StyleSheet, TouchableOpacity, Text, View,RefreshControl, PanResponder, Animated, Dimensions, SafeAreaView, FlatList } from 'react-native';
      ...
      >
        <View style={styles.titleContainer}>
        {
          ...
          <Text style={styles.titleText}> 
            {isCurrent !== null && <>{isCurrent ? "Mes " : "Ses "}</>}Personnels
          </Text>
