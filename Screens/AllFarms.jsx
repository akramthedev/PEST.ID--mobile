...
import { Image, ScrollView, StyleSheet, TouchableOpacity, Text, View, PanResponder,RefreshControl, Animated, Dimensions, SafeAreaView, FlatList } from 'react-native';
...
const axiosInstance = rateLimit(axios.create(), {
  ...
  perMilliseconds: 1000, // time window in 
});
